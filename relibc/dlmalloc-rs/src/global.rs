...
/// A lock guard for the current allocator instance.
struct Instance;

/// Get the current instance, acquiring the global lock.
///
/// # SAFETY: Although there's a RAII guard, access to the inner Dlmalloc is unsafe.
