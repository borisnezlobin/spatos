...
extern __typeof (xfce_panel_set_image_from_source) IA__xfce_panel_set_image_from_source __attribute((visibility("hidden")));
...
extern __typeof (xfce_panel_plugin_popup_menu) IA__xfce_panel_plugin_popup_menu __attribute((visibility("hidden")));
